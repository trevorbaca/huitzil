...
% CLOSE_BRACKETS:
  ...
  %! baca.path.extern()
number.1.RH.Music_Voice = {
    % ABSOLUTE_BEFORE:
    % COMMANDS:

      %! baca._comment_measure_numbers()
    % [RH.Music_Voice measure 1]
    % BEFORE:
    % COMMANDS:
