...
D_String_Contact_Point_Voice = {                                               %! extern
    c'4
    :16
    _ \markup {
        \dynamic
...
D_Underlying_Dynamics_Voice = {                                                %! extern
