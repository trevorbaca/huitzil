L_Global_Rests = {                                                             %! extern
    ...
    % [L Global_Rests measure 56 / measure 2]                                  %! _comment_measure_numbers
    R1 * 13/12                                                                 %! _make_global_rests(1)

    % [L Global_Rests measure 57 / measure 3]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 58 / measure 4]                                  %! _comment_measure_numbers
    R1 * 7/6                                                                   %! _make_global_rests(1)

    % [L Global_Rests measure 59 / measure 5]                                  %! _comment_measure_numbers
    R1 * 53/30                                                                 %! _make_global_rests(1)

    % [L Global_Rests measure 60 / measure 6]                                  %! _comment_measure_numbers
    R1 * 23/12                                                                 %! _make_global_rests(1)

    % [L Global_Rests measure 61 / measure 7]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 62 / measure 8]                                  %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 63 / measure 9]                                  %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_global_rests(1)

    % [L Global_Rests measure 64 / measure 10]                                 %! _comment_measure_numbers
    R1 * 2/3                                                                   %! _make_global_rests(1)

    % [L Global_Rests measure 65 / measure 11]                                 %! _comment_measure_numbers
    R1 * 22/15                                                                 %! _make_global_rests(1)

    % [L Global_Rests measure 66 / measure 12]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 67 / measure 13]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 68 / measure 14]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 69 / measure 15]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 70 / measure 16]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 71 / measure 17]                                 %! _comment_measure_numbers
    R1 * 1/3                                                                   %! _make_global_rests(1)

    % [L Global_Rests measure 72 / measure 18]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 73 / measure 19]                                 %! _comment_measure_numbers
    R1 * 4/5                                                                   %! _make_global_rests(1)

    % [L Global_Rests measure 74 / measure 20]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 75 / measure 21]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 76 / measure 22]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 77 / measure 23]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 78 / measure 24]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 79 / measure 25]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 80 / measure 26]                                 %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_global_rests(1)

    % [L Global_Rests measure 81 / measure 27]                                 %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 56 / measure 2]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 57 / measure 3]                                  %! _comment_measure_numbers
    \time 1/1                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 58 / measure 4]                                  %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 59 / measure 5]                                  %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 60 / measure 6]                                  %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 61 / measure 7]                                  %! _comment_measure_numbers
    \time 1/1                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 62 / measure 8]                                  %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 63 / measure 9]                                  %! _comment_measure_numbers
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 64 / measure 10]                                 %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 65 / measure 11]                                 %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 66 / measure 12]                                 %! _comment_measure_numbers
    \time 1/1                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 67 / measure 13]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 68 / measure 14]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 69 / measure 15]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 70 / measure 16]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 71 / measure 17]                                 %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 72 / measure 18]                                 %! _comment_measure_numbers
    \time 1/1                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 73 / measure 19]                                 %! _comment_measure_numbers
    #(ly:expect-warning "strange time signature found")                        %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 74 / measure 20]                                 %! _comment_measure_numbers
    \time 1/1                                                                  %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca-time-signature-color #'blue                                          %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 75 / measure 21]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 76 / measure 22]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 77 / measure 23]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 78 / measure 24]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 79 / measure 25]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 80 / measure 26]                                 %! _comment_measure_numbers
    s1 * 1                                                                     %! _make_global_skips(1)
%@% \bacaStopTextSpanLMI                                                       %! LOCAL_MEASURE_INDEX_MARKUP
    \bacaStopTextSpanLMN                                                       %! LOCAL_MEASURE_NUMBER_MARKUP
%@% \bacaStopTextSpanMN                                                        %! MEASURE_NUMBER_MARKUP
...
%@% \bacaStartTextSpanCT                                                       %! CLOCK_TIME_MARKUP
    ...
    % [L Global_Skips measure 81 / measure 27]                                 %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
%@% \override RHStaff.Clef.color = ##f                                         %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    \times 2/3 {
        ...
        % [L RH_Music_Voice measure 58 / measure 4]                            %! _comment_measure_numbers
        g'1
        :32                                                                    %! baca_stem_tremolo:IndicatorCommand
    ...
    % [L RH_Music_Voice measure 60 / measure 6]                                %! _comment_measure_numbers
    g'2
    :32                                                                        %! baca_stem_tremolo:IndicatorCommand
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    - \tweak to-barline ##t                                                    %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(1)
    ...
    \times 2/3 {
        ...
        % [L RH_Music_Voice measure 64 / measure 10]                           %! _comment_measure_numbers
        e'2
        :32                                                                    %! baca_stem_tremolo:IndicatorCommand
        \!                                                                     %! baca_hairpin:PiecewiseCommand(2)
        - \tweak color #(x11-color 'blue)                                      %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    % [L RH_Music_Voice measure 70 / measure 16]                               %! _comment_measure_numbers
    f1
    :32                                                                        %! baca_stem_tremolo:IndicatorCommand
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    \mf                                                                        %! EXPLICIT_DYNAMIC:_set_status_tag:baca_hairpin:PiecewiseCommand(2)
    ...
    \times 2/3 {
        ...
        % [L RH_Music_Voice measure 72 / measure 18]                           %! _comment_measure_numbers
        b'2
        :32                                                                    %! baca_stem_tremolo:IndicatorCommand
        _ \baca-mfz-markup                                                     %! baca_markup:IndicatorCommand
        \glissando                                                             %! baca_glissando
    ...
    % [L RH_Music_Voice measure 79 / measure 25]                               %! _comment_measure_numbers
    f1
    :32                                                                        %! baca_stem_tremolo:IndicatorCommand
    _ \baca-ffz-markup                                                         %! baca_markup:IndicatorCommand
    \stopTextSpan                                                              %! baca_text_spanner:PiecewiseCommand(1)
    ...
    % [L RH_Music_Voice measure 80 / measure 26]                               %! _comment_measure_numbers
    d1
    :32                                                                        %! baca_stem_tremolo:IndicatorCommand
    - \tweak color #(x11-color 'blue)                                          %! EXPLICIT_DYNAMIC_COLOR:_treat_persistent_wrapper(1)
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [L RH_Music_Voice measure 81 / measure 27]                       %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [L RH_Rest_Voice measure 81 / measure 27]                        %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
...
L_Cello_Music_Voice = {                                                        %! extern
    ...
    % [L Cello_Music_Voice measure 59 / measure 5]                             %! _comment_measure_numbers
    R1 * 53/30                                                                 %! _make_measure_silences

    % [L Cello_Music_Voice measure 60 / measure 6]                             %! _comment_measure_numbers
    R1 * 23/12                                                                 %! _make_measure_silences

    % [L Cello_Music_Voice measure 61 / measure 7]                             %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 62 / measure 8]                             %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 63 / measure 9]                             %! _comment_measure_numbers
    R1 * 3/4                                                                   %! _make_measure_silences

    % [L Cello_Music_Voice measure 64 / measure 10]                            %! _comment_measure_numbers
    R1 * 2/3                                                                   %! _make_measure_silences

    % [L Cello_Music_Voice measure 65 / measure 11]                            %! _comment_measure_numbers
    R1 * 22/15                                                                 %! _make_measure_silences

    % [L Cello_Music_Voice measure 66 / measure 12]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 67 / measure 13]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 68 / measure 14]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 69 / measure 15]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 70 / measure 16]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 71 / measure 17]                            %! _comment_measure_numbers
    R1 * 1/3                                                                   %! _make_measure_silences

    % [L Cello_Music_Voice measure 72 / measure 18]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 73 / measure 19]                            %! _comment_measure_numbers
    R1 * 4/5                                                                   %! _make_measure_silences

    % [L Cello_Music_Voice measure 74 / measure 20]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 75 / measure 21]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 76 / measure 22]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 77 / measure 23]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 78 / measure 24]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences

    % [L Cello_Music_Voice measure 79 / measure 25]                            %! _comment_measure_numbers
    R1 * 1                                                                     %! _make_measure_silences
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [L Cello_Music_Voice measure 81 / measure 27]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [L Cello_Rest_Voice measure 81 / measure 27]                     %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
