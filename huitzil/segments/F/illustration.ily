F_Global_Rests = {                                                             %! abjad.Path.extern()
    ...
    % [F Global_Rests measure 174 / measure 24]                                %! PHANTOM:baca.SegmentMaker._style_phantom_measures(4):baca.SegmentMaker._comment_measure_numbers()
...
%@% - \baca-metronome-mark-spanner-left-text 2 0 1 "88"                        %! REAPPLIED_METRONOME_MARK:baca.SegmentMaker._set_status_tag():baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER:baca.SegmentMaker._label_measure_numbers()
    ...
    % [F Global_Skips measure 174 / measure 24]                                %! PHANTOM:baca.SegmentMaker._style_phantom_measures(1):baca.SegmentMaker._comment_measure_numbers()
...
%%% \breathe                                                                   %! baca.breathe():+SCORE:baca.IndicatorCommand._call()
    ...
    <<                                                                         %! PHANTOM:baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        {                                                                      %! PHANTOM:baca.SegmentMaker._make_multimeasure_rest_container()
            ...
            % [F RH_Music_Voice measure 174 / measure 24]                      %! PHANTOM:baca.SegmentMaker._style_phantom_measures(5):baca.SegmentMaker._comment_measure_numbers()
        ...
        {                                                                      %! PHANTOM:baca.SegmentMaker._make_multimeasure_rest_container()
            ...
            % [F RH_Rest_Voice measure 174 / measure 24]                       %! PHANTOM:baca.SegmentMaker._style_phantom_measures(5):baca.SegmentMaker._comment_measure_numbers()
...
%@% ^ \baca-duration-multiplier-markup #"2" #"3"                               %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
...
%@% ^ \baca-duration-multiplier-markup #"4" #"5"                               %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
...
%@% ^ \baca-duration-multiplier-markup #"2" #"3"                               %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
    ...
    %@% ^ \baca-duration-multiplier-markup #"107" #"30"                        %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
        \repeatTie                                                             %! baca.repeat_tie():baca.IndicatorCommand._call()
        \glissando                                                             %! baca.glissando()

        cf,!1 * 1/5                                                            %! baca.skeleton()
    %@% ^ \baca-duration-multiplier-markup #"1" #"5"                           %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
        \glissando                                                             %! baca.glissando()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container()
            ...
            \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container()
            c'1 * 2/3                                                          %! PHANTOM_NOTE:baca.SegmentMaker._make_multimeasure_rest_container()
        %@% ^ \baca-duration-multiplier-markup #"2" #"3"                       %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
...
%@% ^ \baca-duration-multiplier-markup #"1" #"2"                               %! DURATION_MULTIPLIER:baca.SegmentMaker._label_duration_multipliers()
    ...
    <<                                                                         %! PHANTOM:baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        {                                                                      %! PHANTOM:baca.SegmentMaker._make_multimeasure_rest_container()
            ...
            % [F Cello_Music_Voice measure 174 / measure 24]                   %! PHANTOM:baca.SegmentMaker._style_phantom_measures(5):baca.SegmentMaker._comment_measure_numbers()
            \baca-invisible-music                                              %! PHANTOM:baca.SegmentMaker._style_phantom_measures(5):baca.SegmentMaker._make_multimeasure_rest_container()
        ...
        {                                                                      %! PHANTOM:baca.SegmentMaker._make_multimeasure_rest_container()
            ...
            % [F Cello_Rest_Voice measure 174 / measure 24]                    %! PHANTOM:baca.SegmentMaker._style_phantom_measures(5):baca.SegmentMaker._comment_measure_numbers()
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:baca.SegmentMaker._style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:baca.SegmentMaker._style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:baca.SegmentMaker._style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:baca.SegmentMaker._style_phantom_measures(8)
