...
<<                                                                             %! baca.SingleStaffScoreTemplate.__call__()
    ...
    <<                                                                         %! abjad.ScoreTemplate._make_global_context()
        ...
        {   %*% Page_Layout                                                    %! abjad.ScoreTemplate._make_global_context()
            ...
            \baca-lbsd #50 #'(15)                                              %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! BREAK
            %! baca.IndicatorCommand._call()
            \baca-lbsd #77 #'(15)                                              %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! BREAK
            %! baca.IndicatorCommand._call()
            \baca-lbsd #104 #'(15)                                             %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
            \break                                                             %! BREAK:baca.IndicatorCommand._call()
            %! baca.SegmentMaker._make_global_skips(1)
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! BREAK
            %! baca.IndicatorCommand._call()
            \baca-lbsd #131 #'(15)                                             %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
            \break                                                             %! BREAK:baca.IndicatorCommand._call()
            %! baca.SegmentMaker._make_global_skips(1)
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! BREAK
            %! baca.IndicatorCommand._call()
            \baca-lbsd #158 #'(15)                                             %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
            \break                                                             %! BREAK:baca.IndicatorCommand._call()
            %! baca.SegmentMaker._make_global_skips(1)
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! BREAK
            %! baca.IndicatorCommand._call()
            \baca-lbsd #185 #'(15)                                             %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
            \break                                                             %! BREAK:baca.IndicatorCommand._call()
            %! baca.SegmentMaker._make_global_skips(1)
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            %! BREAK
            %! baca.IndicatorCommand._call()
            \baca-lbsd #212 #'(15)                                             %! BREAK:baca.IndicatorCommand._call()
            %! BREAK
            %! baca.IndicatorCommand._call()
            \break                                                             %! BREAK:baca.IndicatorCommand._call()
            %! baca.SegmentMaker._make_global_skips(1)
