...
A_String_Contact_Point_Voice = {                                               %! extern
    a''2
    :16
    _ \markup {
        \dynamic
...
A_Underlying_Dynamics_Voice = {                                                %! extern
...
A_Pitch_Voice = {                                                              %! extern
    \clef "bass"
    b,,1 * 539/20
}                                                                              %! extern


A_Pitch_Staff = {                                                              %! extern
