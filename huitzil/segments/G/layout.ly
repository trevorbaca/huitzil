...
% measure_count = 59 + 1
% time_signatures = [
% '3/8', '1/6', '3/8', '3/8', '1/6', '3/8', '1/4', '1/6', '3/8', '1/4', '1/6',
%  '3/8', '1/2', '3/8', '1/6', '3/8', '1/4', '3/8', '1/6', '1/2', '3/8', '1/6',
%  '3/8', '3/8', '1/6', '3/8', '1/4', '1/6', '3/8', '1/4', '1/6', '3/8', '1/2',
%  '3/8', '1/6', '3/8', '1/4', '3/8', '1/6', '1/2', '3/8', '1/6', '3/8', '1/4',
%  '3/8', '1/6', '1/2', '3/8', '1/4', '3/8', '1/6', '1/2', '3/8', '1/6', '3/8',
%  '1/4', '3/8', '1/6', '1/2'
%  ]
...
<<                                                                             %! baca.SingleStaffScoreTemplate.__call__
    ...
    <<                                                                         %! abjad.ScoreTemplate._make_global_context
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING
            ...
            \baca-new-spacing-section #1 #40                                   %! HorizontalSpacingSpecifier(1):SPACING_COMMAND
            \noBreak                                                           %! BreakMeasureMap(2):BREAK
            \baca-lbsd #87 #'(8 20)                                            %! BREAK:IndicatorCommand
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING
            ...
            \baca-new-spacing-section #1 #40                                   %! HorizontalSpacingSpecifier(1):SPACING_COMMAND
            \noBreak                                                           %! BreakMeasureMap(2):BREAK
            \baca-lbsd #157 #'(8 20)                                           %! BREAK:IndicatorCommand
            \break                                                             %! BREAK:IndicatorCommand
            s1 * 3/8                                                           %! _make_global_skips(1)
        %@% \bacaStopTextSpanSPM                                               %! SPACING
        %@% - \baca-start-spm-left-only "[1/40]"                               %! SPACING
