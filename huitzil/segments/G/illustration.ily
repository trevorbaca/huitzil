G_Global_Rests = {                                                             %! abjad.Path.extern
    ...
    % [G Global_Rests measure 200 / measure 27]                                %! PHANTOM:_style_phantom_measures(4):_comment_measure_numbers
...
%@% \bacaStartTextSpanMN                                                       %! MEASURE_NUMBER
    - \baca-start-ct-both "[7'52'']" "[7'54'']"                                %! CLOCK_TIME
    \bacaStartTextSpanCT                                                       %! CLOCK_TIME
    \baca-bar-line-visible                                                     %! _attach_final_bar_line
    \bar "|"                                                                   %! _attach_final_bar_line

    % [G Global_Skips measure 200 / measure 27]                                %! PHANTOM:_style_phantom_measures(1):_comment_measure_numbers
...
%@% \override RHStaff.Clef.color = ##f                                         %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    \once \override RHStaff.StaffSymbol.line-positions = #'(8.2 8 7.8 6 4 2 0 -2 -4 -5.8 -6 -6.2 -8 -10 -12 -14 -16 -17.8 -18 -18.2)\startStaff %! baca_literal:IndicatorCommand
    d1
    :32                                                                        %! baca_stem_tremolo:IndicatorCommand
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G RH_Music_Voice measure 200 / measure 27]                      %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        %@% \glissando                                                         %! PHANTOM:_style_phantom_measures(5):SHOW_TO_JOIN_BROKEN_SPANNERS
            \!                                                                 %! PHANTOM:_style_phantom_measures(5):baca_hairpin:HIDE_TO_JOIN_BROKEN_SPANNERS
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G RH_Rest_Voice measure 200 / measure 27]                       %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
...
G_Cello_Music_Voice = {                                                        %! abjad.Path.extern
    ...
    <<                                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            c'1 * 3/16                                                         %! _make_multimeasure_rest_container
        ...
        {                                                                      %! _make_multimeasure_rest_container
            ...
            R1 * 3/16                                                          %! _make_multimeasure_rest_container
    ...
    R1 * 3/16                                                                  %! _make_measure_silences
...

    {
        ...
        - \tweak self-alignment-X #-0.05                                       %! baca_markup:IndicatorCommand
    ...
    <<                                                                         %! PHANTOM:_make_multimeasure_rest_container
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Cello_Music_Voice measure 200 / measure 27]                   %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \baca-invisible-music                                              %! PHANTOM:_style_phantom_measures(5):_make_multimeasure_rest_container
            c'1 * 1/4                                                          %! PHANTOM:_make_multimeasure_rest_container
        %@% \glissando                                                         %! PHANTOM:_style_phantom_measures(5):SHOW_TO_JOIN_BROKEN_SPANNERS
        ...
        {                                                                      %! PHANTOM:_make_multimeasure_rest_container
            ...
            % [G Cello_Rest_Voice measure 200 / measure 27]                    %! PHANTOM:_style_phantom_measures(5):_comment_measure_numbers
            \once \override Score.TimeSignature.X-extent = ##f                 %! PHANTOM:_style_phantom_measures(6)
            \once \override MultiMeasureRest.transparent = ##t                 %! PHANTOM:_style_phantom_measures(7)
            \stopStaff                                                         %! PHANTOM:_style_phantom_measures(8)
            \once \override Staff.StaffSymbol.transparent = ##t                %! PHANTOM:_style_phantom_measures(8)
